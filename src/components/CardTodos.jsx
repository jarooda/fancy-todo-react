...
const Card = (props) => {
  ...
  return (
      <div className=" sm:w-5/12 w-full mx-3 sm:h-80 h-96 overflow-y-auto text-center px-4 flex flex-wrap justify-center mt-4 rounded-lg hover:-translate-y-2 hover:border-blue-300 border-2 transform shadow bg-wave bg-top bg-no-repeat">
