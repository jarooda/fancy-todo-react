...
const Card = (props) => {  
  return (
      ...
      className={`sm:w-5/12 lg:w-3/12 w-full mx-2 min-h-60 overflow-y-auto text-center px-4 flex flex-wrap justify-center mt-4 rounded-lg self-start ${props.todo.status ? "bg-gray-200" : "hover:-translate-y-2 hover:border-blue-300 border-2 transform shadow bg-wave bg-top bg-no-repeat"}`}
      >
